...
RSpec.describe 'User show page', type: :feature do
  before do
    ...
    @post1 = create(:post, author: @user, title: 'Post 1', text: 'text of post 1')
    @post2 = create(:post, author: @user, title: 'Post 2', text: 'text of post 2')
    @post3 = create(:post, author: @user, title: 'Post 3', text: 'text of post 3')
